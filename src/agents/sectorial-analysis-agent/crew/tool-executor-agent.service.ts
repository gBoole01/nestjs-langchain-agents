...
export class ToolExecutorAgent implements OnModuleInit {
  ...
  private initializeAgent(): void {
    ...
    this.agent = createAgent({
      ...
      systemPrompt: `You are a highly skilled research assistant specialized in industry/sector research.
Your sole purpose is to retrieve high-quality, relevant data about a specific industry sector's outlook (demand trends, competitive landscape, regulation, input costs, key players).
